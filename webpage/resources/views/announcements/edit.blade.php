<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Announcment bearbeiten') }}
        </h2>
    </x-slot>

    <form method="POST" action="{{ route('announcements.update', ["announcement" => $announcement->id]) }}" class="flex flex-wrap ticker-admin-announcement-form">
        @csrf
        @method('PUT')
